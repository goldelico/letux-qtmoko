 ...
 * Command line was: qfsodbusxml2cpp -p qfsogsmdevice -c QFsoGSMDevice specs/xml/org.freesmartphone.GSM.Device.xml
 *
...
#ifndef QFSOGSMDEVICE_H_1306329414
#define QFSOGSMDEVICE_H_1306329414
 ...
 */
class QFsoGSMDevice: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    QFsoGSMDevice(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
