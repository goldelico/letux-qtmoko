...
/*
 * Implementation of interface class QFsoNetwork
 */

QFsoNetwork::QFsoNetwork(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : QFsoDbusAbstractInterface(service, path, staticInterfaceName(), connection, parent)
{
}

QFsoNetwork::~QFsoNetwork()
{
}
