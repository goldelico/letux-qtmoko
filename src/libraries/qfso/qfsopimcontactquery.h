...
#ifndef QFSOPIMCONTACTQUERY_H_1306329414
#define QFSOPIMCONTACTQUERY_H_1306329414
 ...
 */
class QFsoPIMContactQuery: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public Q_SLOTS: // METHODS
    ...
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("GetContactPath"), argumentList);
    }
