 ...
 */
class QFSO_EXPORT QFsoPIMCallQuery: public QFsoDbusAbstractInterface
{
    Q_OBJECT
public:
...
public Q_SLOTS: // METHODS
    ...
    inline QFsoDBusPendingReply<QString> GetCallPath()
    {
        QList<QVariant> argumentList;
        return fsoAsyncCall(QLatin1String("GetCallPath"), argumentList);
    }
