 ...
 * Command line was: qofonodbusxml2cpp -p ofonoconnectionmanager ofono.xml org.ofono.ConnectionManager
 *
...
#ifndef OFONOCONNECTIONMANAGER_H
#define OFONOCONNECTIONMANAGER_H
