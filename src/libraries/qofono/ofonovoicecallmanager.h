 ...
 * Command line was: qofonodbusxml2cpp -p ofonovoicecallmanager ofono.xml org.ofono.VoiceCallManager
 *
 ...
 */
class QOFONO_EXPORT OrgOfonoVoiceCallManagerInterface: public QOFonoDbusAbstractInterface
{
    Q_OBJECT
public:
