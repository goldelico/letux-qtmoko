 ...
 * Command line was: qofonodbusxml2cpp -p qofononetworkoperator ofono-operator.xml org.ofono.NetworkOperator
 *
 ...
 */
class QOFONO_EXPORT OrgOfonoNetworkOperatorInterface: public QOFonoDbusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    OrgOfonoNetworkOperatorInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~OrgOfonoNetworkOperatorInterface();
...
namespace org {
  namespace ofono {
    typedef ::OrgOfonoNetworkOperatorInterface NetworkOperator;
  }
}
#endif
