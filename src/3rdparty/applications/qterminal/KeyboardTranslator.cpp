...
{
#ifdef QTOPIA_PHONE
  return Qtopia::qtopiaDir()+"/etc/qterminal/"+name+".keytab";
#else
  return "/opt/Qtopia/etc/qterminal/"+name+".keytab";
#endif
}
...
{
  /* hmm I think this should go to the personal settings */
