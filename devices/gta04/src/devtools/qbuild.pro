...
desktop.files+=desktop/gps-standby-enter.desktop
desktop.files+=desktop/gps-standby-leave.desktop
desktop.files+=desktop/agps-dump.desktop
desktop.files+=desktop/agps-load.desktop
desktop.files+=desktop/wifi-poweron.desktop
desktop.files+=desktop/wifi-poweroff.desktop
...
desktop.files+=desktop/gsm-bt-fix-start.desktop
desktop.files+=desktop/gsm-bt-fix-stop.desktop
